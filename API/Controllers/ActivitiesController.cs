...
namespace API.Controllers 
{
    public class ActivitiesController : BaseApiController
    {
        ...
        {
            return ResultHandler<Unit>(await Mediator.Send(new Create.Command { Activity = activity }));
        }
        ...
        {
            activity.Id = id;
            return ResultHandler<Unit>(await Mediator.Send(new Edit.Command { Activity = activity }));
        }

        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteActivity(Guid id)
        {
            return ResultHandler<Unit>(await Mediator.Send(new Delete.Command { Id = id }));
        }
    }
}
